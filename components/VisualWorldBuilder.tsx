        ...
        <div className="flex flex-col h-[90vh] bg-slate-50 relative">
            ...
            <header className="flex justify-between items-center p-6 bg-white border-b border-slate-200">
                ...
                <div className="flex gap-4">
                    ...
                    <button onClick={onClose} className="bg-slate-100 hover:bg-slate-200 text-slate-700 px-4 py-2 rounded-full font-bold shadow-sm transition flex items-center gap-2">
