        ...
        <div className="relative flex flex-col items-center justify-center select-none" style={{ width: size, height: size }}>
            ...
            {showLabel && (
                <div className="absolute flex flex-col items-center justify-center text-center pointer-events-none">
                    <span className="text-[10px] font-black tracking-widest text-[#165b3d] uppercase leading-none mb-1">PROMEDIO</span>
                    <span className="text-2xl font-black text-[#0a2d1d] leading-none tracking-tight">{Math.round((outPct + midPct + innPct) / 3)}%</span>
                </div>
            )}
        </div>
    );
...
<body>
    ...
    return (
        <div className="space-y-8 animate-fade-in pb-24 text-[#0a2d1d]">
            {/* SECCIÓN PRINCIPAL: PANEL DE CONTROL, FILTROS Y MÉTRICAS GRUPALES UNIFICADAS */}
            <div className="relative overflow-hidden bg-white/70 backdrop-blur-md border border-[#c1ebd5] shadow-md rounded-[2.5rem] p-6 sm:p-8 space-y-6 text-[#0a2d1d]">
                {/* Glow decorativo de fondo */}
                <div className="absolute right-0 top-0 w-[300px] h-[300px] bg-[#c1ebd5]/20 blur-[80px] rounded-full pointer-events-none" />
                <div className="absolute left-0 bottom-0 w-[200px] h-[200px] bg-[#f0fbf5]/20 blur-[80px] rounded-full pointer-events-none" />

                {/* 1. Fila de Encabezado: Título y Acciones Unificadas (Alumnos, PDF) */}
                <div className="relative z-10 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 pb-4 border-b border-[#f0fbf5]">
                    <div className="flex items-center gap-2">
                        <span className="w-2.5 h-2.5 rounded-full bg-[#165b3d] animate-pulse" />
                        <h2 className="text-xs font-black text-[#0a2d1d] uppercase tracking-widest">Panel de Control de Aula</h2>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full xl:w-auto justify-start xl:justify-end">
                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                            <button 
                                ...
                                className="flex items-center gap-1.5 bg-[#0a2d1d] hover:bg-[#10422c] text-white px-3 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all active:scale-95 shadow-sm cursor-pointer"
                            >
                            ...
                            <button 
                                ...
                                className="flex items-center gap-1.5 bg-[#f0fbf5] hover:bg-[#c1ebd5] text-[#165b3d] px-3 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all active:scale-95 border border-[#c1ebd5] cursor-pointer"
                            >
                ...
                <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex justify-between items-center px-1">
                            <label className="text-[8px] font-black uppercase tracking-wider text-[#2e9f6c]">Salón de Clases</label>
                            <div className="flex gap-1.5">
                                <button onClick={onOpenAddClassroom} className="text-[#2e9f6c] hover:text-[#0a2d1d] cursor-pointer" title="Nuevo Salón">
                                ...
                                {selectedClassroomId !== "all" && (
                                    <>
                                        <button 
                                            ...
                                            className="text-[#2e9f6c] hover:text-[#0a2d1d] cursor-pointer" 
                                            title="Editar Salón"
                                        >
                                            <Pencil className="w-2.5 h-2.5" />
                                        </button>
                                        <button onClick={() => onDeleteClassroom(selectedClassroomId)} className="text-[#2e9f6c] hover:text-rose-500 cursor-pointer" title="Eliminar Salón">
                        ...
                        <div className="relative">
                            <Users className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#2e9f6c]" />
                            <select
                                value={selectedClassroomId}
                                onChange={(e) => setSelectedClassroomId(e.target.value)}
                                className="w-full pl-8 pr-3 py-1.5 bg-[#f0fbf5] border border-[#c1ebd5] rounded-xl text-[10px] font-black uppercase tracking-widest text-[#165b3d] focus:outline-none truncate"
                            >
                    ...
                    <div className="flex flex-col gap-1">
                        <label className="text-[8px] font-black uppercase tracking-wider text-[#2e9f6c] px-1">Proyecto / Mapa Activo</label>
                        <div className="relative">
                            <BookOpen className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#2e9f6c]" />
                            <select
                    ...
                    {/* Buscar Alumno */}
                    <div className="flex flex-col gap-1">
                        <label className="text-[8px] font-black uppercase tracking-wider text-[#2e9f6c] px-1">Buscar Alumno</label>
                        <div className="relative">
                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#2e9f6c]" />
                            <input
                                type="text"
                                placeholder="Nombre..."
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                                className="w-full pl-8 pr-3 py-1.5 bg-[#f0fbf5] border border-[#c1ebd5] rounded-xl text-[10px] font-bold text-[#0a2d1d] placeholder-[#2e9f6c] focus:outline-none"
                            />
                        </div>
                    </div>
                    ...
                    {/* Estado de Alerta */}
                    <div className="flex flex-col gap-1">
                        <label className="text-[8px] font-black uppercase tracking-wider text-[#2e9f6c] px-1">Estado de Alerta</label>
                        <div className="relative">
                            <Filter className="absolute left-3 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-[#2e9f6c]" />
                            <select
                                value={statusFilter}
                                onChange={(e) => setStatusFilter(e.target.value)}
                                className="w-full pl-8 pr-3 py-1.5 bg-[#f0fbf5] border border-[#c1ebd5] rounded-xl text-[10px] font-black uppercase tracking-widest text-[#165b3d] focus:outline-none"
                            >
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-14 pt-6 border-t border-[#f0fbf5]">
                    {/* Anillos de Actividad del Grupo (El Héroe Visual - ¡GIGANTE!) */}
                    <div className="relative shrink-0 flex items-center justify-center bg-[#f0fbf5] border border-[#c1ebd5] p-8 rounded-full shadow-sm transition-all hover:scale-105">
                        <ActivityRings 
                    ...
                    <div className="flex-1 space-y-6 w-full">
                        <div>
                            <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#2e9f6c]">Métricas Generales de Aula</span>
                            <h3 className="text-2xl font-black text-[#0a2d1d] tracking-tight leading-none mt-1.5">Desempeño Promedio del Grupo</h3>
                        </div>

                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            {/* Avance de Mapas */}
                            <div className="flex items-center gap-3 p-4 bg-white border border-[#c1ebd5] rounded-2xl hover:bg-[#f0fbf5]/50 transition-all shadow-sm">
                                <div className="w-3.5 h-3.5 rounded-full bg-[#165b3d] shrink-0 shadow-sm" />
                                <div>
                                    <h4 className="text-[9px] font-black uppercase tracking-wider text-[#165b3d]">Avance de Mapas</h4>
                                    <p className="text-xl font-black text-[#0a2d1d] tracking-tight leading-none mt-1">{groupMetrics.progress}%</p>
                                </div>
                            </div>

                            {/* Promedio Académico */}
                            <div className="flex items-center gap-3 p-4 bg-white border border-[#c1ebd5] rounded-2xl hover:bg-[#f0fbf5]/50 transition-all shadow-sm">
                                <div className="w-3.5 h-3.5 rounded-full bg-[#2e9f6c] shrink-0 shadow-sm" />
                                <div>
                                    <h4 className="text-[9px] font-black uppercase tracking-wider text-[#165b3d]">Promedio Académico</h4>
                                    <p className="text-xl font-black text-[#0a2d1d] tracking-tight leading-none mt-1">{(groupMetrics.academic / 10).toFixed(1)} / 10</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 p-4 bg-white border border-[#c1ebd5] rounded-2xl hover:bg-[#f0fbf5]/50 transition-all shadow-sm">
                                ...
                                <div>
                                    <h4 className="text-[9px] font-black uppercase tracking-wider text-[#165b3d]">Tasa de Entrega</h4>
                                    <p className="text-xl font-black text-[#0a2d1d] tracking-tight leading-none mt-1">{groupMetrics.submission}%</p>
                                </div>
                            </div>
                        </div>

                        {/* Resumen de Alertas en Grupo */}
                        <div className="flex flex-wrap gap-2 pt-3 border-t border-[#c1ebd5]">
            ...
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <h3 className="text-lg font-black tracking-tight text-[#0a2d1d]">Alumnos del Salón ({filteredStudents.length})</h3>
                    <span className="text-[10px] font-black uppercase text-[#2e9f6c] tracking-wider bg-white px-3 py-1 border border-[#c1ebd5] rounded-full">
                        Semáforo Académico Activo
                    </span>
                </div>

                {filteredStudents.length === 0 ? (
                    <div className="bg-white p-16 border-2 border-dashed border-[#c1ebd5] rounded-[2rem] text-center">
                        <div className="text-5xl mb-4">🔍</div>
                        <p className="font-black text-lg text-[#0a2d1d]">No se encontraron alumnos</p>
                        <p className="text-xs text-[#2e9f6c] mt-1 font-bold">Verifica tus filtros o términos de búsqueda.</p>
                    </div>
                ) : (
                        ...
                        {filteredStudents.map(student => {
                            ...
                            return (
                                <button
                                    ...
                                    className="group text-left bg-white hover:bg-slate-50 border border-[#c1ebd5] hover:border-[#2e9f6c] p-5 rounded-[2rem] transition-all duration-300 shadow-sm hover:shadow-xl flex items-center justify-between gap-6 cursor-pointer active:scale-98"
                                >
                                    <div className="flex-1 space-y-4 min-w-0">
                                        <div className="flex items-center gap-3">
                                            <div className="w-12 h-12 bg-[#f0fbf5] group-hover:bg-[#c1ebd5] rounded-full flex items-center justify-center text-2xl shrink-0 transition-colors shadow-inner border border-[#c1ebd5]">
                                                {student.avatar || "🧑🏻"}
                                            </div>
                                            <div className="min-w-0">
                                                <h4 className="font-black text-base truncate tracking-tight text-[#0a2d1d]">{student.name}</h4>
                                        ...
                                        <div className="space-y-1.5">
                                            <div className="flex items-center justify-between text-[10px] text-[#2e9f6c] font-bold">
                                                <span>Avance:</span>
                                                <span className="font-black text-[#0a2d1d]">{outerVal}%</span>
                                            </div>
                                            <div className="flex items-center justify-between text-[10px] text-[#2e9f6c] font-bold">
                                        ...
                                        <div className="flex items-center justify-between pt-3 border-t border-[#f0fbf5] text-[9px] font-black uppercase tracking-widest text-[#2e9f6c] group-hover:text-[#0a2d1d] transition-colors">
                                    ...
                                    {/* Mini Anillo Lateral */}
                                    <div className="shrink-0 bg-[#f0fbf5] p-3 rounded-2xl border border-[#c1ebd5] shadow-sm">
            ...
            {showStudentModal && selectedStudent && (() => {
                ...
                return (
                    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
                        <div className="bg-white rounded-[2.5rem] border border-[#c1ebd5] w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col md:flex-row relative animate-in zoom-in-95 duration-200">
                            ...
                            <button 
                                ...
                                className="absolute top-5 right-5 p-2 bg-[#f0fbf5] hover:bg-[#c1ebd5] text-[#2e9f6c] hover:text-[#0a2d1d] rounded-full transition-all z-20 cursor-pointer active:scale-95"
                            >
                                <X className="w-5 h-5" />
                            </button>

                            {/* LATERAL DE ANILLOS Y RECOMPENSAS (LIGHT THEME) */}
                            <div className="md:w-1/3 bg-[#f0fbf5] text-[#0a2d1d] p-8 flex flex-col items-center justify-between gap-8 shrink-0 rounded-t-[2.5rem] md:rounded-t-none md:rounded-l-[2.5rem] border-r border-[#c1ebd5]">
                                <div className="text-center w-full space-y-4">
                                    <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center text-4xl mx-auto shadow-sm border border-[#c1ebd5]">
                                        {selectedStudent.avatar || "🧑🏻"}
                                    </div>
                                    <div>
                                        <h3 className="font-black text-xl tracking-tight leading-none text-[#0a2d1d]">{selectedStudent.name}</h3>
                                        <p className="text-[10px] text-[#2e9f6c] font-black uppercase tracking-widest mt-1.5">Código: {selectedStudent.studentCode || "—"}</p>
                                    </div>
                                    {/* Botones de Edición y Eliminación */}
                                    <div className="flex justify-center gap-2 pt-2">
                                        <button 
                                            onClick={() => onEditStudent(selectedStudent)}
                                            className="flex items-center justify-center bg-white border border-[#c1ebd5] hover:border-[#2e9f6c] text-[#165b3d] p-2.5 rounded-xl transition-all shadow-sm active:scale-95 cursor-pointer"
                                            title="Editar Alumno"
                                        >
                                ...
                                <div className="w-full space-y-3">
                                    <div className="flex justify-between items-center text-xs p-3 bg-white border border-[#c1ebd5] rounded-xl shadow-sm">
                                        <span className="text-[#165b3d] font-black uppercase text-[9px] tracking-wider">Puntos XP</span>
                                        <span className="font-black text-amber-600 tabular-nums">{selectedStudent.xp || 0} XP</span>
                                    </div>
                                    <div className="flex justify-between items-center text-xs p-3 bg-white border border-[#c1ebd5] rounded-xl shadow-sm">
                                        <span className="text-[#165b3d] font-black uppercase text-[9px] tracking-wider">Monedas/Gemas</span>
                                        <span className="font-black text-emerald-600 tabular-nums">{selectedStudent.gems || 0} Gemas</span>
                                    </div>
                                    <div className="flex justify-between items-center text-xs p-3 bg-white border border-[#c1ebd5] rounded-xl shadow-sm">
                                        <span className="text-[#165b3d] font-black uppercase text-[9px] tracking-wider">Racha</span>
                            ...
                            <div className="flex-1 p-8 space-y-8 overflow-y-auto">
                                <div>
                                    <span className="text-[9px] font-black uppercase tracking-widest text-[#2e9f6c]">Panel de Seguimiento</span>
                                    <h3 className="text-2xl font-black text-[#0a2d1d] tracking-tight">Análisis Académico Detallado</h3>
                                </div>

                                {/* DESGLOSE DE MATERIAS Y PROGRESO */}
                                <div className="space-y-4">
                                    <h4 className="font-black text-xs uppercase tracking-wider text-[#165b3d] flex items-center gap-2">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {studentWorlds.map(w => {
                                            ...
                                            return (
                                                <div key={w.id} className="p-4 bg-[#f0fbf5]/50 border border-[#c1ebd5] rounded-2xl space-y-3">
                                                    <div className="flex justify-between items-start">
                                                        <h5 className="font-black text-sm text-[#0a2d1d] truncate pr-2">{w.title}</h5>
                                                        <span className="text-[10px] font-black bg-white px-2 py-0.5 border border-[#c1ebd5] rounded text-[#30D158]">
                                                            {wGrade.toFixed(1)}/10
                                                        </span>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <div className="flex justify-between items-center text-[10px] font-black text-[#2e9f6c] uppercase tracking-wider">
                                                            <span>Progreso:</span>
                                                            <span>{wProgress}%</span>
                                                        </div>
                                                        <div className="w-full bg-[#c1ebd5] h-2 rounded-full overflow-hidden">
                                ...
                                <div className="p-5 bg-gradient-to-br from-[#0a2d1d]/5 to-[#165b3d]/5 border border-[#c1ebd5] rounded-[2rem] space-y-4">
                                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                                        <div className="flex items-center gap-2">
                                            <div className="p-2 bg-white rounded-xl border border-[#c1ebd5] text-[#165b3d]">
                                                <BrainCircuit className="w-5 h-5 animate-pulse" />
                                            </div>
                                            <div>
                                                <h4 className="font-black text-sm tracking-tight text-[#0a2d1d]">Recomendación de AprendIA</h4>
                                                <p className="text-[9px] font-black text-[#2e9f6c] uppercase tracking-widest">Inteligencia Artificial Pedagógica</p>
                                            </div>
                                        </div>
                                        <select
                                            value={profileScopeWorldId}
                                            onChange={(e) => { setAiReport(null); setProfileScopeWorldId(e.target.value); }}
                                            className="px-3.5 py-2 bg-white border border-[#c1ebd5] rounded-xl text-[10px] font-black uppercase tracking-widest text-[#165b3d] focus:outline-none w-full sm:w-auto"
                                        >
                                    ...
                                    <div className="border-t border-[#c1ebd5] pt-4">
                                        {aiReport ? (
                                            <div className="bg-white p-4 rounded-xl border border-[#c1ebd5] text-xs leading-relaxed text-[#0a2d1d] max-h-60 overflow-y-auto font-medium prose prose-indigo w-full">
                                            ...
                                            <div className="flex items-center gap-3 p-4">
                                                ...
                                                <span className="text-[#0a2d1d] font-medium text-xs">Generando reporte con IA...</span>
                                            </div>
                                        ) : (
                                            <>
                                                <p className="text-xs leading-relaxed text-[#0a2d1d] font-medium bg-white/60 p-4 border border-white rounded-xl mb-3">
                                                    {outerVal < 30 ? (
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-2">
                                                    <button
                                                        ...
                                                        className="flex-1 bg-[#0a2d1d] hover:bg-[#10422c] text-white px-4 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer shadow-sm"
                                                    >
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex-1 bg-[#f0fbf5] hover:bg-[#c1ebd5] border border-[#c1ebd5] text-[#165b3d] px-4 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer shadow-sm"
                                                    >
                                    ...
                                    <div className="flex flex-wrap gap-2 pt-2">
                                        <button
                                            ...
                                            className="flex items-center gap-2 bg-white text-[#0a2d1d] border border-[#c1ebd5] hover:border-[#2e9f6c] px-5 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all active:scale-95 disabled:opacity-50"
                                        >
                                            <Sparkles className="w-4 h-4 text-[#165b3d]" />
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-[#f0fbf5]">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex gap-2">
                                            <input 
                                                ...
                                                className="w-20 px-3 py-2 bg-[#f0fbf5] border border-[#c1ebd5] rounded-xl text-xs font-bold text-[#0a2d1d] focus:outline-none"
                                                min="1"
                                            />
                                            <button
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex gap-2">
                                            <input 
                                                ...
                                                className="flex-1 px-3 py-2 bg-[#f0fbf5] border border-[#c1ebd5] rounded-xl text-xs text-[#0a2d1d] focus:outline-none placeholder-[#2e9f6c]"
                                            />
                                            <button
                                                onClick={() => handleQuickAction("message")}
                                                className="bg-[#0a2d1d] hover:bg-[#10422c] text-white font-bold text-[10px] uppercase tracking-widest px-4 py-2 rounded-xl transition-all active:scale-95 cursor-pointer"
                                            >
                                                Enviar
                                            </button>
                                        </div>
                                ...
                                {actionMessageStatus && (
                                    <p className="text-center font-bold text-xs p-3 bg-[#f0fbf5] border border-[#c1ebd5] rounded-2xl text-[#165b3d] animate-fade-in">
                                        {actionMessageStatus}
                                    </p>
                                )}
                            </div>
