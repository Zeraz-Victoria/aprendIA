    ...
    return (
        <div className="fixed inset-0 z-[70] bg-black/90 flex items-center justify-center backdrop-blur-lg p-4 overflow-y-auto">
            <div className={`w-full max-w-lg transition-all duration-700 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="bg-slate-900 rounded-3xl border-2 border-slate-700 shadow-2xl overflow-hidden">
                    ...
                    <div className="flex justify-center -mt-10 relative z-10">
                        <div className={`w-20 h-20 bg-gradient-to-br ${gradeGradient} rounded-full flex items-center justify-center shadow-2xl border-4 border-slate-900`}>
                            <span className="text-3xl font-black text-white">{report.grade}</span>
                        </div>
                    </div>
                    <p className="text-center text-slate-300 font-bold mt-2 text-lg">{report.gradeLabel}</p>
                    <p className="text-center text-slate-500 text-sm px-6 mt-1">{report.message}</p>
                    ...
                    <div className="flex justify-center gap-6 mt-4 px-6">
                        ...
                        <div className="text-center">
                            <span className="text-2xl">💎</span>
                            <p className="text-blue-400 font-bold text-sm">{stats.gems} Gemas</p>
                        </div>
                        <div className="text-center">
                            <span className="text-2xl">🔥</span>
                    ...
                    <div className="p-6 space-y-4 mt-2">
                        ...
                        <div className="bg-sky-950/40 border border-sky-800/50 rounded-2xl p-4">
                            <h3 className="text-sky-400 font-bold text-sm uppercase tracking-wider flex items-center gap-2 mb-2">
                                <BookOpen className="w-4 h-4" /> Qué Repasar
                            </h3>
                            <ul className="space-y-1">
                                {report.reviewTopics.map((r, i) => (
                                    <li key={i} className="text-sky-200 text-sm flex items-start gap-2">
