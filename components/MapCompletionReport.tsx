    ...
    return (
        <div className="fixed inset-0 z-[70] bg-black/90 flex items-center justify-center backdrop-blur-lg p-4 overflow-y-auto">
            <div className={`w-full max-w-lg transition-all duration-700 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="bg-[#0a2d1d] rounded-3xl border-2 border-[#165b3d] shadow-2xl overflow-hidden">
                    ...
                    <div className="flex justify-center -mt-10 relative z-10">
                        <div className={`w-20 h-20 bg-gradient-to-br ${gradeGradient} rounded-full flex items-center justify-center shadow-2xl border-4 border-[#0a2d1d]`}>
                            <span className="text-3xl font-black text-white">{report.grade}</span>
                        </div>
                    </div>
                    <p className="text-center text-[#2e9f6c] font-bold mt-2 text-lg">{report.gradeLabel}</p>
                    <p className="text-center text-[#2e9f6c] text-sm px-6 mt-1">{report.message}</p>
                    ...
                    <div className="flex justify-center gap-6 mt-4 px-6">
                        ...
                        <div className="text-center">
                            <span className="text-2xl">💎</span>
                            <p className="text-[#2e9f6c] font-bold text-sm">{stats.gems} Gemas</p>
                        </div>
                        <div className="text-center">
                            <span className="text-2xl">🔥</span>
                    ...
                    <div className="p-6 space-y-4 mt-2">
                        ...
                        <div className="bg-sky-950/40 border border-sky-800/50 rounded-2xl p-4">
                            <h3 className="text-[#2e9f6c] font-bold text-sm uppercase tracking-wider flex items-center gap-2 mb-2">
                                <BookOpen className="w-4 h-4" /> Qué Repasar
                            </h3>
                            <ul className="space-y-1">
                                {report.reviewTopics.map((r, i) => (
                                    <li key={i} className="text-[#c1ebd5] text-sm flex items-start gap-2">
                    ...
                    <div className="p-6 pt-0">
                        ...
                        <p className="text-center text-[#2e9f6c] text-xs mt-3">
